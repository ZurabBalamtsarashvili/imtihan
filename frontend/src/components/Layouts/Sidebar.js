...
export default function Sidebar(className) {
    ...
    return (
        <aside
            className={`${className} bg-white border-r border-zinc-200 drop-shadow-sm sm:hidden md:hidden lg:block xl:block 2xl:block hidden overflow-auto w-72 dark:border-zinc-800 dark:bg-black z-auto`}>
            <Avatar />
